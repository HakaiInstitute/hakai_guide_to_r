...
For collaboration on R scripts with Google Drive to work you must have the desktop version of Google Drive installed. You must also use a project oriented workflow that utilizes R-Studio Projects, and the  `here()` package which solves the issues of different working directories.
