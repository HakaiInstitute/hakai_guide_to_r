...
# note: you need to be able to log in to google drive to use this method
...
# Either read in a .csv file of your sites with lat and long, or create the dataframe manually as done here.
xy <- data.frame(
