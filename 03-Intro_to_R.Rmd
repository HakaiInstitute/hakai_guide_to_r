...
they can visualize and model, will explore their data the most and therefore learn the most about their data.
...
Before moving on to the next chapter, work through these chapters and all the exercises in R for Data Science:
...
These chapters will give you a solid foundation from which to build, and should be considered a minimum. Feel free to work through the other chapters in the R for Data Science book as the need comes up.