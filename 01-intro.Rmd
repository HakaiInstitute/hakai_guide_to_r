...
Most University courses that use R are focused on teaching statistical techniques such as generalized linear models, or logistic regression — which is very necessary and important — but pay no attention to educating students on how to actually conduct an analysis from start to finish. Questions that often remain un-answered include:
...
* How do I efficiently produce a professional report or other artifact of my analysis to communicate?
...
* Dr. Hillary Parker, Stitch-fix, [Twitter]('https://twitter.com/hspter')
