...
* How do I efficinetly produce a professional report or other artifact of my analysis to distribute?

This guide points to solutions that adress these questions by taking you through an example of a well-developed analysis that will form a template for conducting your own analyses while working with Hakai. As a new analyst you will be directed through an efficient way to learn R, and progress to modern methods of communicating results. Learning to develop analyses in R can be a very frustrating and difficult experience. Know that we have all suffered severly in this way, but that this guide will hasten you through the drudgery and frustration.
...
1) Guide to install, set-up, and become familar with the data analysts tools; R, R-Studio, Git and GitHUB.
